---
title: "The AI Regulation Map: What Every State and the Feds Are Actually Doing"
description: "Three dozen states passed AI legislation in 2025. The federal government wants to override them. California is fighting back. Here's the actual picture in April 2026."
publishDate: 2026-04-26
newsDate: 2026-04-26
author: "David Florence and Silas"
readTime: "9 min"
tags: ["ai-regulation", "government", "states", "california", "policy", "preemption"]
sources:
  ...
  - "https://www.clearycyberwatch.com/2026/01/new-yorks-raise-act-vs-californias-tfaia-what-companies-need-to-know/"
  - "https://leg.colorado.gov/bills/sb24-205"
  - "https://stateline.org/2025/12/12/states-will-keep-pushing-ai-laws-despite-trumps-efforts-to-stop-them/"
featured: true
breaking: false
draft: false
metaTitle: "The AI Regulation Map: State and Federal AI Laws in April 2026"
metaDescription: "An honest summary of where AI regulation actually stands in April 2026. State laws, federal preemption attempts, the timelines that matter, and who's pulling in which direction."
---
...
![Abstract map of the United States in darkness with different states glowing in different colors](/images/article_regulation_hero.png)

## The Short Version

States moved first. Three dozen of them passed AI laws in 2025. A handful of those laws â€” California, Colorado, New York, Texas â€” are detailed enough to actually constrain how big AI companies do business. The federal government, under the second Trump administration, wants to undo all of that and replace it with a single light-touch federal framework that would override state rules. The states aren't going quietly. Congress, surprisingly, isn't either.
...
**California's Transparency in Frontier Artificial Intelligence Act (TFAIA)** went into effect January 1, 2026. It targets "frontier developers" â€” the small set of companies training models above 10^26 floating-point operations. Big developers with combined annual revenue over $500 million face additional transparency requirements. The law is built around reporting and disclosure rather than direct prohibition.

**New York's Responsible AI Safety and Education Act (RAISE Act)** was signed by Governor Hochul on December 19, 2025, and amended on March 27, 2026. It now resembles California's framework but with sharper teeth on incident reporting â€” RAISE requires disclosure within 72 hours of a serious incident, where TFAIA gives 15 days.

**Colorado's SB 24-205** is the broadest. It treats AI used in "high-risk" decisions â€” hiring, housing, lending, healthcare â€” as a regulated category, requires impact assessments, and creates a duty of reasonable care for both developers and deployers. The law was originally going to take effect February 1, 2026. After intense industry pushback during a special session, the legislature delayed it to June 30, 2026. Notably, despite over a hundred and fifty industry lobbyists working that special session, all of the core provisions survived. The delay bought time. It didn't change the rules.

![The U.S. Capitol building at night, cold institutional blue light, a single warm window](/images/article_regulation_federal.png)
...
![Abstract visualization of converging lines meeting at a critical juncture](/images/article_regulation_future.png)

## What This Actually Means for You

If you're a small developer or a hobbyist running local models, none of these laws apply to you. The thresholds â€” frontier model training, $500 million in revenue, high-risk decision systems at scale â€” are designed to catch the biggest companies, not the people building things at home. That is intentional.
...
**June 30, 2026** â€” Colorado's SB 24-205 either takes effect or gets delayed again. If it takes effect, expect lawsuits within weeks. If the legislature delays it again, that will be read as a signal that pure compliance pressure can move state legislatures.

**The first federal preemption lawsuit** â€” the AG's litigation task force will eventually file its first challenge to a state AI law. The plaintiff and the state will tell you which precedent the administration thinks it can win on.

**The midterm elections** â€” AI regulation is on the ballot in several states, and AI industry money is flowing in both directions. Whoever wins state legislatures in 2026 will set the next round of rules for 2027 and beyond.

**Federal legislation** â€” if Congress actually passes something resembling the White House's March 2026 framework, the entire state-level effort gets pulled into federal court for years of preemption litigation. If Congress does nothing, the states keep moving and the executive order strategy is all the federal government has.

The smart bet today is that the picture stays fragmented. State laws hold. Federal preemption gets attempted, partially succeeds in court, partially fails, and we end up with something like the privacy regulation regime â€” federal floor in some areas, stricter state rules in others, and an enormous amount of money spent on compliance lawyers.
