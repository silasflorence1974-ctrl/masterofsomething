...
Yes. Here's what you actually need â€” and what the tutorials leave out.
...
That distinction matters â€” the gap between how something looks in a
...
servers â€” your prompts travel to their hardware, get processed, and the
...
everyday tasks â€” summarizing, drafting, answering questions, helping you
think through a problem â€” you will barely notice the difference. For
...
## Our Setup â€” What We're Working With
...
*This is the machine Silas runs on. Your results may vary â€” but this
...
| RAM | 16GB DDR5 |
| GPU | NVIDIA RTX 4060 Ti â€” 8GB VRAM |
...
## Before You Start â€” What You Need in Place
...
spec box above â€” that is what we use, not what you need to start. A
...
An SSD is strongly preferred over a spinning hard drive â€” model load
...
first â€” open it, type `echo hello`, press Enter. That is the whole
...
download is 5â€“8GB so a slow connection means a long wait.
...
current OS versions. If you are on Windows 10, it still works â€” just
...
runs quietly in the background â€” you will see a small icon in your
...
|----------------|-------------------|-----|
| 4â€“6GB | Gemma 3 4B or Llama 3.2 3B | Fast, capable, fits comfortably |
| 8GB | Qwen 3 8B or Llama 3.1 8B | Strong quality, our daily driver |
| 12GB+ | Llama 3.1 70B (quantized) | Near-frontier quality locally |

If you do not have a dedicated GPU, do not worry â€” Ollama runs on CPU
...
The first run downloads the model â€” about 5GB. After that it loads from
your local drive in seconds. You will see a prompt appear. Type
something. It will respond.

![Amber characters appearing on a dark screen â€” first contact](/images/article1_awakening.png)
...
phone, your laptop, anywhere you are â€” without exposing it to the
internet.
...
Once installed, Tailscale assigns each device a private IP address â€”
...
Now open a chat app that supports custom Ollama endpoints â€” we use
**Open WebUI** (more on that in the next article) â€” point it at your
...
On Windows, go to **Settings â†’ System â†’ Power â†’ Screen and sleep** and
...
For the full setup we run â€” where the AI handles overnight tasks,
monitors the house, and prepares morning briefings â€” the machine runs
...
5â€“8GB over a typical home connection is 10â€“20 minutes. This is normal.
...
model is too large for your available VRAM â€” go down a size.
...
This is the foundation. Everything we build from here â€” memory,
tools, autonomous tasks, voice, home automation integration â€” runs on
...
This article covers the foundation layer. Our complete setup goes further â€”
...
*Next in the series: [Setting Up Open WebUI â€” A Proper Interface for
