...
On **March 9, 2026**, Anthropic files lawsuits in two federal courts — the Northern District of California and the District of Columbia. ([CBS News](https://www.cbsnews.com/news/anthropic-pentagon-supply-chain-risk-lawsuit/), [CNN Business](https://www.cnn.com/2026/03/09/tech/anthropic-sues-pentagon))
...
Anthropic's usage policy prohibits Claude from being deployed in weapon systems that select and engage targets without human authorization. The DoD wanted that restriction loosened. Whether it would have been *used* for autonomous weapons is a separate question — they wanted the *option*.
...
- **Public First Action** — a 501(c)(4) backed by Anthropic with a $20 million contribution. Mission framed as AI policy education and supporting candidates from both parties (30-50 in state and federal races) who favor measured AI regulation. Important caveat: as a 501(c)(4), Public First Action cannot legally fund direct campaign ads — its money goes to issue advocacy and education. Anthropic separately filed paperwork in early 2026 to form **AnthroPAC**, which can. ([CNBC](https://www.cnbc.com/2026/02/12/anthropic-gives-20-million-to-group-pushing-for-ai-regulations-.html), [Axios](https://www.axios.com/2026/02/12/anthropic-millions-ai-policy-fight))
...
![A single glowing terminal in darkness, a figure watching from a distance — the outside observer looking in](/images/article_pentagon_close.png)
