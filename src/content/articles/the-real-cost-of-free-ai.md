...
description: "You're not paying for ChatGPT with money. You're paying with something else. Here's what actually happens to your data â€” and the practical steps that change it."
...
hidden. It's not expensive in the way you'd expect. It's just the API tier â€” the 
developer-facing product â€” and almost no one outside tech circles knows it exists.
...
conversations is how the math works. The API tier â€” where they don't train â€” 
...
![Two streams of light flowing in opposite directions â€” paid privacy vs. free training](/images/article5_data.png)
...
in future training runs. Their API product â€” the one developers pay for â€” 
...
opt-out in Settings â†’ Data Controls â†’ "Improve the model for everyone." Turning 
it off stops future conversations from being used for training. It does not 
delete conversations already collected â€” that's a separate request. Team and 
...
privacy surface â€” most people do â€” Gemini adds more data to it than the others.
...
- **ChatGPT:** Settings â†’ Data Controls â†’ toggle off "Improve the model for everyone"
- **Claude.ai:** Settings â†’ Privacy â†’ review the training toggle
- **Gemini:** myactivity.google.com â†’ Gemini Apps Activity â†’ adjust retention

These affect future conversations only. They don't retroactively unwind training 
that's already happened on prior data. And they'll need to be re-checked â€” 
...
them, or train on them. The trade-off is real â€” local models aren't as capable 
as the frontier for hard tasks â€” but for the majority of daily AI use (drafting, 
summarizing, explaining, thinking out loud), the gap is smaller than most people 
expect.

The practical setup â€” a mid-range desktop, Ollama, a 7-9B model, optionally 
Tailscale to reach it from anywhere â€” costs roughly what one year of an AI 
...
isn't just what you clicked â€” it's what you said, in your own words, when you 
